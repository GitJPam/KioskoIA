  ...
  const handleOpenRegister = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.error(result.message || "Error al abrir la caja");
      }
    } catch {
                        ...
                        <TableCell>
                          <div>
                            <p className="font-medium">
                              {item.closingDate
                                ? formatShortDate(item.closingDate)
                                : formatShortDate(item.openingDate)}
                            </p>
            ...
            {detailLoading ? (
              ...
              <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                      <div>
                        ...
                        <p className="font-medium">{formatCurrency(selectedRegister.initialCash)}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Efectivo Esperado</p>
                        <p className="font-medium">
                          {formatCurrency(selectedRegister.expectedCash || 0)}
                        </p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Efectivo Real</p>
                        <p className="font-medium">
                          {formatCurrency(selectedRegister.actualCash || 0)}
                        </p>
                      </div>
                      <div>
                ...
                {selectedRegister.notes && (
                  <div className="bg-amber-50 p-3 rounded-lg border border-amber-200">
                    <p className="text-sm text-amber-800">
                      <strong>Notas:</strong> {selectedRegister.notes}
                    </p>
                  </div>
                )}
                ...
                {selectedRegister.sales && selectedRegister.sales.length > 0 && (
                  <div>
                    <h4 className="font-medium mb-3">Últimas Ventas</h4>
